...
router.put('/updatehobbyiestrequest/:status/:requestid', mentorController.updateHobbyistRequestStatus); // fix frontend 
...
router.get('/retrivevementoreventAttendance/:firstname/:lastname/:phonenumber', mentorController.getMentorEventAttendance); // Need to implement in frontend 
